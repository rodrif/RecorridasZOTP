...
public class RegistrationIntentService extends IntentService {
    ...
    private void subscribeOrUnsuscribeTopics(String token) throws IOException {
        ...
        pubSub.unsubscribe(token, "/topics/" + Utils.ROL_ADMIN_STRING + "-dev");
        pubSub.unsubscribe(token, "/topics/" + Utils.ROL_REFERENTE_STRING + "-dev");
        pubSub.unsubscribe(token, "/topics/" + Utils.ROL_COORDINADOR_STRING + "-dev");
        pubSub.unsubscribe(token, "/topics/" + Utils.ROL_VOLUNTARIO_STRING + "-dev");
        pubSub.unsubscribe(token, "/topics/" + Utils.ROL_INVITADO_STRING + "-dev");
        if (Config.getInstance().isLoginOk()) {
            ...
            for (String topic : TOPICS) {
                Log.d(Utils.APPTAG, "Suscrito a topic: " + topic + "-dev");
                pubSub.subscribe(token, "/topics/" + topic + "-dev", null);
            }
        }
    }
